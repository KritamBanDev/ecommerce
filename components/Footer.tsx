...
const Footer = () => {
  return (
    <footer
      className="relative overflow-hidden backdrop-blur-xl bg-white/70 dark:bg-neutral-900/80 shadow-2xl border-0 rounded-t-3xl mt-16"
      style={{
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="space-y-5">
            <Logo className="text-3xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-fuchsia-500 to-pink-500 drop-shadow-lg">
              E-commerce
            </Logo>
            <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed font-medium mt-2">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-5 text-lg tracking-wide">
              Quick Links
            </h3>
            <ul className="space-y-3">
              {quickLinksData?.map((item) => (
                <li key={item?.title}>
                  <Link
                    href={item?.href}
                    className="footer-link text-gray-600 dark:text-gray-300 text-base font-medium"
                  >
                    {item?.title}
                  </Link>
                </li>
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300 text-base mb-4 font-medium">
            ...
            <form className="space-y-3">
              <input
                ...
                required
                className="footer-newsletter-input w-full px-4 py-2 rounded-xl focus:outline-none text-base"
              />
              <button
                type="submit"
                className="footer-newsletter-btn w-full px-4 py-2 rounded-xl transition-colors text-base"
              >
                Subscribe
              </button>
            </form>
